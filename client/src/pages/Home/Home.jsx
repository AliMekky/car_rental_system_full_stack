    ...
    <div>
      ...
      <div className='middle-section row'>
        <div className = "paragraph col-12 col-sm-4">
            <p className = "par1">Nothing can stop you from having the perfect trip!</p>
            <p className='par2'>We promise you ultimate safety, comfort, and a choice tailored for your needs.</p>
        </div>
      ...
      <div className = "last-section">
        <div className='row'>
          <div className = "col-3" style = {{"textAlign" : "left"}}>
              <div className = "go"><span>GO CAR.</span></div>
              <div className = "slogan">your dream car, just when it crosses your mind.</div>
          </div>
          <div className = "col-3" style = {{"textAlign" : "left"}}>
          ...
          <div className = "col-3" style = {{"textAlign" : "left"}}>
              ...
              <p className = "founder">Lara Hassan <br/><br/>Nourine Mohamed<br/><br/>Ali Mekky <br/><br/>Anas Emad</p>
          </div>
      ...
      <div className = "footer">
          <hr/>
          <span >
            © 2022 GO CAR, all rights reserved.
          </span>
